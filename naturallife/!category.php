<?php include"header.php";?>
	...
	<div class="bottom-body">
		<div class="wrapper">
			...
			<p>March 22, 2013 By <?php comment_author(); ?></p>
			<div class="clear"></div>
           		...
           		<p>I was just doing some writting and development for the 
                next upcoming major event that me and Liam are teaching 
                together and I relaised that I’ve never blogged about this 
                class. Over the last few years I have seen this class change 
                the lives of hundreds of guys that we have trained over the 
                years. </p>
